...
<<<<<<< HEAD
    cafe_owners = [
        ...
        {'username': 'alisonscott', 'first_name': 'Alison', 'last_name': 'Scott', 'email': 'alisonscott@outlook.com',
         'password': '5tB@e7Pl', 'owner': True},
        {'username': 'jonathan23', 'first_name': 'Jonathan', 'last_name': 'Holland', 'email': 'jonathan23@outlook.com',
         'password': '!2FgA@pm', 'owner': True}]

    customers = [{'username': 'jakehill', 'first_name': 'Jake', 'last_name': 'Hill', 'email': 'jakehill@gmail.com',
                  'password': 'Sm&4R8pA', 'owner': False},
                 {'username': 'tomwalker', 'first_name': 'Tom', 'last_name': 'Walker', 'email': 'tomwalker@gmail.com',
                  'password': '$pm%5td3', 'owner': False},
                 {'username': 'caroline99', 'first_name': 'Caroline', 'last_name': 'Mcdonald',
                  'email': 'carolinemacdonald99@outlook.com', 'password': '2p#mT@!d', 'owner': False},
                 {'username': 'johnson34', 'first_name': 'Johnson', 'last_name': 'Hill',
                  'email': 'johnsonhill@outlook.com', 'password': '!2FgA@pm', 'owner': False}]
    ...
    cafes = {'xeniaskotti': [
        ...
        {'cafe_name': 'CoffeeRiver', 'pricepoint': 2, 'picture': 'cafe_images/CoffeeRiver.jpg',
         'address': '7 Keith St, Glasgow G11 6QQ', 'opening_hours': '9am to 5pm'}],
             'alisonscott': [{'cafe_name': 'Starbucks', 'pricepoint': 3,
                              'picture': 'cafe_images/Starbucks.jpg',
                              'address': '254 Byres Rd, Glasgow G12 8SH', 'opening_hours': '9am to 5pm'},
                             {'cafe_name': 'Monza', 'pricepoint': 1,
                              'picture': 'cafe_images/Monza.jpg',
                              'address': '13 Vine St, Glasgow G11 6BA', 'opening_hours': '9am to 5pm'}],
             'jonathan23': [
                 {'cafe_name': 'Fika', 'pricepoint': 2, 'picture': 'cafe_images/Fika.jpg',
                  'address': '579 Dumbarton Rd, Glasgow G11 6HY', 'opening_hours': '9am to 5pm'}]}

    reviews = {'Free Spirit': [
        {'customer_username': 'jakehill', 'price': 1, 'service': 2, 'atmosphere': 3, 'quality': 3, 'waiting_time': 5},
        ...
        {'customer_username': 'johnson34', 'price': 3, 'service': 4, 'atmosphere': 4, 'quality': 2, 'waiting_time': 5}],
               'CoffeeRiver': [
                   {'customer_username': 'jakehill', 'price': 2, 'service': 3, 'atmosphere': 3, 'quality': 2,
                    'waiting_time': 3},
                   {'customer_username': 'caroline99', 'price': 2, 'service': 4, 'atmosphere': 2, 'quality': 2,
                    'waiting_time': 3},
                   {'customer_username': 'tomwalker', 'price': 2, 'service': 3, 'atmosphere': 2, 'quality': 2,
                    'waiting_time': 3},
                   {'customer_username': 'johnson34', 'price': 2, 'service': 2, 'atmosphere': 2, 'quality': 2,
                    'waiting_time': 3}],
               'Monza': [{'customer_username': 'tomwalker', 'price': 2, 'service': 2, 'atmosphere': 4, 'quality': 2,
                          'waiting_time': 3},
                         {'customer_username': 'caroline99', 'price': 4, 'service': 4, 'atmosphere': 2, 'quality': 2,
                          'waiting_time': 5},
                         {'customer_username': 'johnson34', 'price': 3, 'service': 4, 'atmosphere': 4, 'quality': 2,
                          'waiting_time': 5}],
               'Starbucks': [{'customer_username': 'jakehill', 'price': 2, 'service': 3, 'atmosphere': 3, 'quality': 3,
                              'waiting_time': 5},
                             {'customer_username': 'tomwalker', 'price': 3, 'service': 3, 'atmosphere': 3, 'quality': 4,
                              'waiting_time': 5},
                             {'customer_username': 'caroline99', 'price': 4, 'service': 4, 'atmosphere': 2,
                              'quality': 2, 'waiting_time': 5},
                             {'customer_username': 'johnson34', 'price': 3, 'service': 4, 'atmosphere': 4, 'quality': 2,
                              'waiting_time': 5}],
               'Fika': [{'customer_username': 'jakehill', 'price': 5, 'service': 5, 'atmosphere': 5, 'quality': 5,
                         'waiting_time': 5},
                        {'customer_username': 'caroline99', 'price': 5, 'service': 4, 'atmosphere': 3, 'quality': 4,
                         'waiting_time': 5},
                        {'customer_username': 'tomwalker', 'price': 5, 'service': 5, 'atmosphere': 5, 'quality': 4,
                         'waiting_time': 5},
                        {'customer_username': 'johnson34', 'price': 5, 'service': 4, 'atmosphere': 4, 'quality': 5,
                         'waiting_time': 5}]
               }
...
>>>>>>> 0476d4de4c75493a3c7c0816bc3679417cc4f0be
    ...
    for owner_data in cafe_owners:
        o = add_user(owner_data["username"], owner_data["first_name"], owner_data["last_name"], owner_data["email"],
                     owner_data["password"], owner_data["owner"])
        for cafe in cafes[owner_data["username"]]:
            ...
            for review in reviews[cafe["cafe_name"]]:
                r = add_review(c, users[review["customer_username"]], review["price"], review["service"],
                               review["atmosphere"], review["quality"], review["waiting_time"])
...
def add_user(username, first_name, last_name, email, password, owner):
    u = User.objects.get_or_create(username=username, first_name=first_name, last_name=last_name, email=email,
                                   password=password)[0]
...
def add_review(cafe, user, price, service, atmosphere, quality, waiting_time):
    r = Review.objects.get_or_create(cafe=cafe, user=user, price=price, service=service, atmosphere=atmosphere,
                                     quality=quality, waiting_time=waiting_time)[0]
